...
<body>
    ...
    <div class="container">
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-dark">
            ...
            <li class="nav-item">
                <a class="nav-link" href="admin.php?page=admin_history">Chat History</a>
            </li>
    ...
    <div>
        <a href="https://www.instagram.com/bagasvi7?igsh=a3lzZTMxeW1jbzY3"
        ><i class="bi bi-instagram h2 p-2 text-dark"></i
        ></a>
        <a href="https://x.com/JuriFF7?t=tbMIqNGOj4tiarBvwEuElQ&s=09"
        ><i class="bi bi-twitter h2 p-2 text-dark"></i
        ></a>
        <a href="https://wa.me/+6282137444502"
        ><i class="bi bi-whatsapp h2 p-2 text-dark"></i
        ></a>
    </div>
    <div>Bagas Vieri Surya Putra &copy; 2025</div>
    </footer>
    <!-- footer end -->
    <script
