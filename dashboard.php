...
//query untuk mengambil data chat history
$sql3 = "SELECT * FROM history_chat ORDER BY tanggal DESC";
$hasil3 = $conn->query($sql3);

//menghitung jumlah baris data chat history
$jumlah_history = $hasil3->num_rows;
...
<div class="row row-cols-1 row-cols-md-4 g-4 justify-content-center pt-4">
    ...
    <div class="col">
        <a href="admin.php?page=admin_history" style="text-decoration:none; color:inherit;">
        <div class="card border border-danger mb-3 shadow" style="max-width: 18rem;">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div class="p-3">
                        <h5 class="card-title">
                            <i class="bi bi-chat-dots"></i> Chat AI History
                        </h5> 
                    </div>
                    <div class="p-3">
