                ...
                <div class="col-lg-10 col-xl-8">
                    <div class="row align-item-center">
                        <div class="col-12 col-md-4 text-center">
                            <img src="img/profil.jpg" class="card-hover rounded-circle shadow mb-3 mb-md-0"
                            ...
                            <div class="card-hover shadow-lg mx-auto">
                                <div class="card-body text-center">
                                    ...
                                    <div class="table-resposive">
                                        <table class="table table-borderless table-sm mx-auto text-center"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td class="text-wrap text-start">Jalan Durian Utara II No.15, RT01 /
                                                        RW02,Semarang</td>
                                                </tr>
                                            </tbody>
                                        </table>
